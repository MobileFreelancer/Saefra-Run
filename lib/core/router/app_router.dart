...
class AppRouter {
  ...
  static GoRouter createRouter(Listenable refreshListenable) => GoRouter(
        ...
        redirect: (context, state) {
          ...
          // Intro + auth are always reachable before login.
          if (!isLoggedIn) {
          ...
          // Logged in: allow password-reset flow without interruption.
          ...
          if (location.startsWith('/onboarding') && isOnboardingComplete) {
            return '/dashboard';
          }
